        ...
        <section id="gtco-welcome" class="bg-white section-padding">
            <div class="container">
                <div class="section-content">
                    <div class="row">
                        <div class="col-sm-5 img-bg d-flex shadow align-items-center justify-content-center 
                justify-content-md-end img-2" style="background-image: url(img/mie2.jpg);">
                        ...
                        <div class="col-sm-7 py-5 pl-md-0 pl-4">
                            ...
                            <div class="pl-lg-5 ml-md-5">
                                <p>Selamat datang di Mie Bangladesh, tempat terbaik untuk menikmati mie autentik yang terinspirasi oleh cita rasa khas Bangladesh. Kami hadir untuk memberikan pengalaman kuliner yang unik, dengan menggunakan bahan-bahan berkualitas dan resep tradisional yang telah diwariskan turun-temurun.
                                    Di Mie Bangladesh, kami percaya bahwa makanan bukan hanya soal rasa, tetapi juga tentang cerita yang terkandung di dalamnya. Setiap piring mie yang kami sajikan dibuat dengan penuh cinta dan perhatian terhadap detail, dari bumbu yang kaya hingga cara penyajiannya yang menggugah selera.</p>
                                <h3 class="mt-5">Special Menu</h3>
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#" class="thumb-menu">
                                            <img class="img-fluid img-cover" src="img/mie3.jpg" />
                                            <h6>Mie Goreng Aceh</h6>
                                        </a>
                                    </div>
                                    <div class="col-4">
                                        <a href="#" class="thumb-menu">
